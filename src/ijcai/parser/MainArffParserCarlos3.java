 ...
 *
 */
public class MainArffParserCarlos3 {

	public static void main(String[] args) throws Exception {
		String csvFileName = "C:/Users/Usuarioç/Desktop/carlos/IJCAI-Competencia/final_data_set/procesados_comprasventas/data_final_userLog_compras-ventas.csv";
		...
		try (Stream<String> stream = Files.lines(Paths.get(csvFileName))) {
			try (PrintWriter arff = new PrintWriter(arffFileName)) {
				...
				arff.printf("@ATTRIBUTE cant_compras_user NUMERIC%n");
				arff.printf("@ATTRIBUTE cant_ventas_merchant NUMERIC%n");
				...
				stream
					.skip(1)
					.map(MainArffParserCarlos3::switchLabel)
